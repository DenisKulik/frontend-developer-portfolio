...
import { SiFigma, SiJest, SiRedux, SiWebpack } from 'react-icons/si'
import {
  TbBrandHtml5,
  TbBrandStorybook,
  TbBrandTypescript,
...
import interviewList from '../assets/interview-list.png'
...
export const projects: ProjectType[] = [
  ...
  },
  {
    ...
    url: 'https://deniskulik.github.io/interview-list',
    technologies: 'Typescript, Vue, Pinia, Vue Router, Firebase, PrimeVue, Chart.js, Vite',
  },
  {
    img: crmSystem,
    title: 'Crm System',
    url: 'https://deniskulik.github.io/crm-system',
    technologies: 'JavaScript, Vue, Vuex, Firebase, ChartJS, Jest, Materialize CSS, Vue CLI',
  },
  {
    img: vueSneakers,
    title: 'Vue Sneakers',
    url: 'https://deniskulik.github.io/vue-sneakers',
    technologies: 'JavaScript, Vue, Vue Router, Pinia, axios, TailwindCSS, Vite',
  },
  {
    img: gameLanding,
    title: 'Game Landing',
